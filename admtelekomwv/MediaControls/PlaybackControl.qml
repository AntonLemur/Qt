...
Rectangle {
    ...
    required property /*MediaPlayer*/VLCPlayer mediaPlayer
    // readonly property int mediaPlayerState: root.mediaPlayer.playbackState
    readonly property bool mediaPlaying: root.mediaPlayer.playbackState
    ...
    states: [
        State {
            name: "playing"
            when: root.mediaPlaying //root.mediaPlayerState === MediaPlayer.PlayingState
        ...
        State {
            name: "paused"
            when: !root.mediaPlaying //root.mediaPlayerState === MediaPlayer.PausedState || root.mediaPlayerState === MediaPlayer.StoppedState
